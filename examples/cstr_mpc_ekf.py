...
class CSTRSystem:
    ...
    def __init__(self, meas_noise_std: float = 0.02):
        self.nx = 2
        self.nu = 1
        self.ny = 1
...
def test_controller(
    ...
    for _ in range(tsim):
        ...
        y_meas = y_true + system.meas_noise_std * rng.normal()
    ...
    if save_path is None:
        save_path = Path(__file__).resolve().parent / "results" / "cstr_controller_test.png"
